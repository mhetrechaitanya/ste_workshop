...
// Update the SidebarItem component to handle both exact matches and subpaths
      ...
      <ScrollArea className="flex-1 px-3 py-2">
        <nav className="flex flex-col gap-1">
          ...
          <SidebarGroup
            ...
            title="Workshops"
            defaultOpen={pathname.includes("/workshops")}
          >
            <SidebarItem
              href="/workshops"
          ...
          <SidebarGroup
            ...
            title="Batches"
            defaultOpen={pathname.includes("/batches")}
          >
            <SidebarItem
              href="/batches"
          ...
          <SidebarGroup
            ...
            title="Students"
            defaultOpen={pathname.includes("/students")}
          >
            <SidebarItem
              href="/students"
          ...
          <SidebarGroup icon={<Mail className="h-5 w-5" />} title="Email" defaultOpen={pathname.includes("/email")}>
            <SidebarItem
              href="/email/send"
